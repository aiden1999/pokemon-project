...
columns = ["hp", "attack", "defense", "sp_attack", "sp_defense", "speed", "total_points"]
...
with manual:
    ...
    if stat_input_X != None and stat_input_Y != None:
            fig = px.scatter(df, x=stat_input_X,
                            y=stat_input_Y,
        ...
        st.error("^^^ Select options in the boxes up there! ^^^", )
...
with pre_set:
    ...
    role = st.selectbox(label="Choose a role:",
    ...
    if stat_input_X_2 != None and stat_input_Y_2 != None:
            fig = px.scatter(df, x=stat_input_X_2,
                            y=stat_input_Y_2,
                            color=(df['type_1'] == has_type_input_2) | (df['type_2'] == has_type_input_2), 
                            labels=display_columns_dict,
                            hover_name='name',
                            hover_data=('type_1', 'type_2'),
                            color_discrete_map={
